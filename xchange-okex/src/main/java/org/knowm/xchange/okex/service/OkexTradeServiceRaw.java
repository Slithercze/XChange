...
public abstract class OkexTradeServiceRaw extends OkexBaseService {
  ...
  public OkexResponse<List<OkexFill>> getFillHistory(
      String instrumentType,
      String after,
      String before)
      throws IOException {
    try {
      return decorateApiCall(
              () ->
                  okexAuthenticated.getFillHistory(
                      instrumentType,
                      after,
                      before,
                      exchange.getExchangeSpecification().getApiKey(),
                      ...
                      (String)
                          exchange
                              .getExchangeSpecification()
                              .getExchangeSpecificParametersItem(PARAM_SIMULATED)))
          .withRateLimiter((rateLimiter(OkexAuthenticated.fillsHistoryPath)))
          .call();
    } catch (OkexException e) {
      throw handleError(e);
    }
